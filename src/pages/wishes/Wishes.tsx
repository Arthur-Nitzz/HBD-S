...
const sampleMessagesDataArray: TMessagesData[] = [
  {
    ...
    messageInParas: [
      "Hey Sneha! 🎉 Hope your birthday’s as amazing and fun as you are.",
      ...
      "Here’s to another year of crushing it, enjoying life, and being unapologetically awesome. Happy Birthday, Sneha!",
      "Swipe ---> Next Page!",
    ],
  ...
  },
  {
    ...
    messageInParas: [
      "Happy Birthday, Sneha! 🎉🎂 I hope your day is so amazing that even your cake is jealous of how sweet you are.",
      ...
      "Eat cake like it’s a sport, laugh like everyone’s watching and dance like no one’s judging (even if your pet is)",
      "Here’s to another year of being ridiculously awesome, slightly chaotic and totally unforgettable. Happy Birthday, Sneha!",
      "Warm regards,",
      "Arthur",
    ],
